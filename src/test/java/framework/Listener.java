...
public class Listener implements WebDriverListener {
	...
	public void afterFindElement(WebDriver driver, By locator, WebElement result) {
		...
		Reporter.log("Done: element found successfully", true);// recommended logging mechanism in automation testing
	}
	...
	public void beforeClick(WebElement element) {
		...
		Reporter.log("About to click the element " + element.getText());
	}
	...
	public void beforeFindElement(WebDriver driver, By locator) {
		...
		Reporter.log("Trying to find element " + locator);
	}
	...
	public void beforeGet(WebDriver driver, String url) {
		...
		Reporter.log("Trying.. navigating to url " + url);
	}
	...
	public void beforeGetText(WebElement element) {
		...
		Reporter.log("Trying.. to get the element text");
	}
